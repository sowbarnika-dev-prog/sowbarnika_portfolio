...
export const Footer = () => {
  ...
  // ✅ Newsletter Submit Handler (Formspree Integration)
  const handleNewsletterSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/xgvrwlqa", {
        method: "POST",
        headers: {
  ...
  const contactInfo = [
    {
      icon: <Mail size={16} />,
      text: "sowbarnikayoganathan57@gmail.com",
    ...
    <footer className="px-6 py-12 mt-20">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Frontend Developer crafting modern, user-friendly web
                experiences.
              </p>
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                ...
                <button
                  ...
                  className="bg-gray-900 hover:bg-gray-800 dark:bg-white dark:hover:bg-gray-200 dark:text-gray-900 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-300 w-full flex justify-center items-center gap-2"
                >
                  {isSubmitting ? (
                    <>
          ...
          >
            <div>
              <p>© {currentYear} Sowbarnika. All rights reserved.</p>
            </div>
